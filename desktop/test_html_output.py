...
def generate_mock_data():
    return {
        ...
        "secondary_driver": "Dollar firm",
        "summary": "10Y up, oil bid, vol up with equities weak",
        "incident": {
            "active": True,
            "message": "DXY spike +1.1%"
        },
        "macro": [
            {"name": "DXY", "value": "104.2", "change": "+0.8%", "direction": "up"},
            {"name": "US10Y", "value": "4.27%", "change": "+9 bps", "direction": "up"},
            {"name": "VIX", "value": "18.4", "change": "+2.1", "direction": "up"},
            {"name": "SPY", "value": "510", "change": "-0.6%", "direction": "down"},
            {"name": "NDX", "value": "17,800", "change": "-0.9%", "direction": "down"},
            {"name": "WTI", "value": "99.64", "change": "+5.46%", "direction": "up"},
            {"name": "XAU", "value": "4524", "change": "+3.40%", "direction": "up"},
            {"name": "XAG", "value": "69.80", "change": "+3.14%", "direction": "up"},
        ],
        "watchlist": [
            {
                "ticker": "SMCI",
                "note": "Watching reclaim of 50 EMA for continuation."
            },
            {
                "ticker": "GDX",
                "note": "Gold reacting to USD strength; watch whether miners confirm."
            },
            {
                "ticker": "USO",
                "note": "Oil strength remains a macro pressure point; monitor follow-through."
            },
        ]
    }
...
if __name__ == "__main__":
    ...
    output_path = "/storage/emulated/0/macro_pulse_test.html"
